            ...
            return (
                <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-amber-100 p-4">
                    <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
                        ...
                        <p className="mt-4 text-red-600">Processing...</p>
                    </div>
                </div>
            );
        }
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full pl-10 pr-4 py-3 rounded-lg border ${errors.firstName ? 'border-red-500' : 'border-gray-300'
                                                        } focus:ring-2 focus:ring-red-200 focus:border-red-500 outline-none transition duration-200`}
                                                />
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full pl-10 pr-4 py-3 rounded-lg border ${errors.lastName ? 'border-red-500' : 'border-gray-300'
                                                        } focus:ring-2 focus:ring-red-200 focus:border-red-500 outline-none transition duration-200`}
                                                />
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-10 pr-4 py-3 rounded-lg border ${errors.optionalPhone ? 'border-red-500' : 'border-gray-300'
                                                    } focus:ring-2 focus:ring-red-200 focus:border-red-500 outline-none transition duration-200`}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-10 pr-4 py-3 rounded-lg border ${errors.configPassword ? 'border-red-500' : 'border-gray-300'
                                                    } focus:ring-2 focus:ring-red-200 focus:border-red-500 outline-none transition duration-200`}
                                            />
                                        </div>
                                        {errors.configPassword && <p className="mt-1 text-sm text-red-600">{errors.configPassword}</p>}
                                    </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-4 md:p-8 max-w-md w-full">
                            ...
                            <div className="text-center mb-8">
                                <div className="flex justify-center mb-4">
                                    <FaEnvelope className="w-12 h-12 text-red-500" />
                                </div>
                                <h1 className="text-2xl font-bold text-red-800 mb-2">Verification Code</h1>
                                <p className="text-red-600">
                                    We've sent a 5-digit code to your {verificationMethod.verification === 'email' ? 'email' : 'phone'}
                                </p>
                            </div>
